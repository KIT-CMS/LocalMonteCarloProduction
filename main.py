...
parser = argparse.ArgumentParser(
    description="A small tool to setup a given McM request for local production"
)
parser.add_argument(
    "--keys",
    help="keys of the configs you want to set up given in the config yaml file",
    nargs="+",
)
parser.add_argument(
    "--config_file", help="yaml file with the configs for the jobs you want to run"
)
